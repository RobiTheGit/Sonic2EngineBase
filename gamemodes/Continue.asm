...
+
	...
	move.l	#ObjDB,(MainCharacter).w ; load ObjDB (sonic on continue screen)
	move.l	#ObjDB,(Sidekick).w ; load ObjDB (tails on continue screen)
	move.b	#6,(Sidekick+routine).w ; => ObjDB_Tails_Init
	move.l	#ObjDA,(ContinueText).w ; load ObjDA (continue screen text)
	move.l	#ObjDA,(ContinueIcons).w ; load ObjDA (continue icons)
