...
Obj1D_InitBall:
	...
	move.w	x_pos(a1),objoff_3C(a1)
	move.w	y_pos(a1),objoff_34(a1)
	move.w	y_vel(a0),y_vel(a1)
	move.w	y_vel(a1),objoff_38(a1)
	move.b	#8,width_pixels(a1)
	move.w	#$60,objoff_3E(a1)
	move.w	#$B,objoff_3A(a1)
	andi.b	#1,d4
	beq.s	+
	neg.w	objoff_3A(a1)
	neg.w	objoff_3E(a1)
