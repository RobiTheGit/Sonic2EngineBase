...
; ----------------------------------------------------------------------------
; OST:
obj0D_spinframe		= objoff_34 ; $30(a0)
obj0D_sparkleframe	= objoff_38 ; $34(a0)
obj0D_finalanim		= objoff_3A ; $36(a0) ; 4 if Tails only, 3 otherwise (determines what character to show)
; ----------------------------------------------------------------------------
...
Load_EndOfAct:
	...
	bsr.w	SingleObjLoad
	bne.s	+
	move.L	#Obj3A,(a1) ; load obj3A (end of level results screen)
+
...
; animation script
; off_1958E:
; Signpost_Spin and Signpost_Spin2 are duplicates, but I am keeping them in case the game really needs it.
; - RobiWanKenobi
Ani_obj0D:	offsetTable
		offsetTableEntry.w Eggman_Sign	; 0
		offsetTableEntry.w Signpost_Spin	; 1
		offsetTableEntry.w Signpost_Spin2	; 2
		offsetTableEntry.w Sonic_Sign	; 3
		offsetTableEntry.w Tails_Sign	; 4
Eggman_Sign:	dc.b	$0F, $02, $FF
	rev02even
Signpost_Spin:	dc.b	$01, $02, $03, $04, $05, $01, $03, $04, $05, $00, $03, $04, $05, $FF
	rev02even
Signpost_Spin2:	dc.b	$01, $02, $03, $04, $05, $01, $03, $04, $05, $00, $03, $04, $05, $FF
	rev02even
Sonic_Sign:	dc.b	$0F, $00, $FF
	rev02even
Tails_Sign:	dc.b	$0F, $01, $FF
	even
; -------------------------------------------------------------------------------
