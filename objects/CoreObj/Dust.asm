...
obj08_previous_frame = objoff_34
obj08_dust_timer = objoff_36
obj08_belongs_to_tails = objoff_38
obj08_vram_address = objoff_40
...
Obj08_MdSpindashDust:
	...
	beq.s	+
	subi.w	#4,y_pos(a0);	; Tails is shorter than Sonic
+
	tst.b	prev_anim(a0)
	bne.s	Obj08_Display
	andi.w	#drawing_mask,art_tile(a0)
...
Obj08_SkidDust:
	...
	bsr.w	SingleObjLoad
	bne.s	loc_1DEE0
	move.l	(a0),(a1) ; load obj08
	move.w	x_pos(a2),x_pos(a1)
	move.w	y_pos(a2),y_pos(a1)
	addi.w	#$10,y_pos(a1)
	tst.b	obj08_belongs_to_tails(a0)
	beq.s	+
	subi.w	#4,y_pos(a1)	; Tails is shorter than Sonic
+
	move.b	#0,status(a1)
	move.b	#3,anim(a1)
	addq.b	#2,routine(a1)
