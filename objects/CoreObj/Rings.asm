...
; Obj_25_sub_6:
Obj25_Sparkle:
	move.w	#make_art_tile(ArtTile_ArtNem_RingSparkle,1,0),art_tile(a0)
	lea	(Ani_Ring).l,a1
	bsr.w	AnimateSprite
	bra.w	DisplaySprite
; ===========================================================================
...
BigRingFlash_Animate:
	...
	movea.l	objoff_40(a0),a1 ; a1=object	; get the parent big ring object
...
; ----------------------------------------------------------------------------
casino_prize_x_pos =		objoff_34	; X position of the ring with greater precision
casino_prize_y_pos =		objoff_38	; Y position of the ring with greater precision
casino_prize_machine_x_pos =	objoff_3C	; X position of the slot machine that generated the ring
casino_prize_machine_y_pos =	objoff_3E	; Y position of the slot machine that generated the ring
casino_prize_display_delay =	objoff_40	; number of frames before which the ring is displayed
; Sprite_125E6:
ObjDC:
	moveq	#0,d0
	move.b	routine(a0),d0
...
; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
; ----------------------------------------------------------------------------
; Object 4C - Attracted ring (ported from Sonic and Knuckles)
; ----------------------------------------------------------------------------
Obj4C:
	moveq	#0,d0
	move.b	routine(a0),d0
	move.w	Obj_4C_subtbl(pc,d0.w),d1
	jmp	Obj_4C_subtbl(pc,d1.w)
; ===========================================================================
Obj_4C_subtbl:
	dc.w	Obj_4C_sub_0-Obj_4C_subtbl; 0
	dc.w	Obj_4C_sub_2-Obj_4C_subtbl; 2
	dc.w	Obj_4C_sub_4-Obj_4C_subtbl; 4
	dc.w	Obj_4C_sub_6-Obj_4C_subtbl; 6
	dc.w	Obj_4C_sub_8-Obj_4C_subtbl; 8
; ===========================================================================
...
Obj_4C_sub_2:
	...
	btst	#status_sec_hasShield,status_secondary(a1)	; Change the #0 to #5 if you've ported the actual lightning shield
	bne.s	+
	move.l	#Obj37,(a0)	; Load object 37 (scattered rings)
	move.b	#2,routine(a0)
	move.b	#-1,(Ring_spill_anim_counter).w
+
