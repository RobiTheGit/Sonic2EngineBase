...
; ----------------------------------------------------------------------------
; OST Variables:
Obj9D_timer		= objoff_2E	; byte
Obj9D_climb_table_index	= objoff_30	; word
Obj9D_attack_timer	= objoff_32	; byte	; time player needs to spend close to object before it attacks
; Sprite_37BFA:
Obj9D:
	moveq	#0,d0
...
Obj9D_StartClimbing:
	...
	jsr	Obj9D_SetClimbingDirection
	jmpto	(MarkObjGone).l, JmpTo39_MarkObjGone
; ---------------------------------------------------------------------------
; loc_37C66:
Obj9D_StartThrowing:
...
+	clr.b	routine_secondary(a0)	; reset routine counter for next time
	...
	jmp	Obj9D_SetClimbingDirection
; ===========================================================================
; loc_37D22:
Obj9D_CreateCoconut:
