...
Obj0E_Sonic_Init:
	...
	move.l	#Obj0E,(a1) ; load obj0E (flashing intro stars) at $FFFFD140
...
+
	...
	move.l	#ObjC9,(a1) ; load objC9 (palette change)
	move.b	#0,subtype(a1)
	st.b	objoff_34(a0)
...
sub_12F08:
	...
	move.l	#Obj0E,(a1) ; load obj0E (flashing intro star) at $FFFFB180
...
-	move.w	d0,(a1)+
	...
	move.l	#ObjC9,(a1) ; load objC9 (palette change handler) at $FFFFB240
	move.b	#2,subtype(a1)
...
+
	...
	move.l	#Obj0E,(a1); load obj0E (flashing intro star) at $FFFFB440
...
loc_130A2:
	...
	move.l	#Obj0E,(a1) ; load obj0E (flashing intro star) at $FFFFB200
...
; ----------------------------------------------------------------------------
ttlscrpalchanger_fadein_time_left = objoff_34
ttlscrpalchanger_fadein_time = objoff_35
ttlscrpalchanger_fadein_amount = objoff_36
ttlscrpalchanger_start_offset = objoff_38
ttlscrpalchanger_length = objoff_3A
ttlscrpalchanger_codeptr = objoff_3E
