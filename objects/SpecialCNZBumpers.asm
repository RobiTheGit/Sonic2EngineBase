...
; ===========================================================================
	...
	even
	dc.w	$0000, $0000, $0000
SpecialCNZBumpers_Act1:	BINCLUDE	"level/object_pos/CNZ 1 bumpers.bin"	; byte_1781A
        even
       	dc.w	$0000, $0000, $0000
SpecialCNZBumpers_Act2:	BINCLUDE	"level/object_pos/CNZ 2 bumpers.bin"	; byte_1795E
          even
; ===========================================================================
