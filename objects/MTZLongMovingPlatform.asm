...
loc_26B6E:
	...
	cmpi.b	#7,(a3)
	bne.s	+
	move.w	objoff_40(a0),objoff_3E(a0)
+
	jsrto	(SingleObjLoad2).l, JmpTo11_SingleObjLoad2
	bne.s	loc_26C04
	move.l	(a0),(a1) ; load obj65
	addq.b	#4,routine(a1)
...
loc_26CC2:
	...
	cmp.w	objoff_3E(a0),d0
	beq.s	loc_26CF2
	addq.w	#2,objoff_3E(a0)
