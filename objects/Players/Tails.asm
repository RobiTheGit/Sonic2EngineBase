...
Obj02_Init_Continued:
	...
	move.l	#Obj05,(Tails_Tails).w ; load Obj05 (Tails' Tails) at $FFFFD000
...
Obj02_InWater:
	...
	movea.l	a0,a1
	bsr.w	ResumeMusic
	move.l	#Obj0A,(Tails_BreathingBubbles).w ; load Obj0A (tail's breathing bubbles) at $FFFFD0C0
	move.b	#$81,(Tails_BreathingBubbles+subtype).w
	move.l	a0,(Tails_BreathingBubbles+objoff_40).w ; set its parent to be this (obj0A uses $3C instead of $3E for some reason)
...
; loc_1C6C4:
Tails_RollJump:
	bset	#2,status(a0) ; set the rolling+jumping flag
	rts
...
TailsAni_FlyCarry_ptr:	offsetTableEntry.w TailsAni_TiredCarry	; 12 ;  $C
...
TailsAni_Carry_ptr:	offsetTableEntry.w TailsAni_Carry		; 32 ; $20
...
TailsAni_SwimTired:	dc.b   7,  $92,  $93,  $94, $93,$FF
	rev02even
TailsAni_TiredCarry:	dc.b   1,$97,$98,$FF
	rev02even
...
TailsAni_Fly:		dc.b   1,$5E,$5F,$FF
	even
TailsAni_Carry:		dc.b   1,$9a,$9b,$FF
	even
...
Obj05_parent_prev_anim = objoff_34
