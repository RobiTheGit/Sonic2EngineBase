...
Obj52_LavaBall_Move:
	...
	asl.l	#4,d0
	add.l	d0,d3
	move.l	d2,objoff_2E(a0)
	move.l	d3,y_pos(a0)
	move.w	objoff_2E(a0),x_pos(a0)
	rts
; ===========================================================================
