...
+
	...
	move.l	#Obj56,(a1) ; load obj56 (EHZ boss)
...
+
	...
	jsrto	(SingleObjLoad).l, JmpTo_SingleObjLoad
	bne.s	+
	move.L	#Obj54,(a1) ; load obj54 (MTZ boss)
+
...
+
	...
	jsrto	(SingleObjLoad).l, JmpTo_SingleObjLoad
	bne.s	+
	move.l	#Obj52,(a1) ; load obj52 (HTZ boss)
+
...
+
	...
	jsrto	(SingleObjLoad).l, JmpTo_SingleObjLoad
	bne.s	+
	move.L	#Obj55,(a1) ; load obj55 (OOZ boss)
+
	addq.b	#2,(Dynamic_Resize_Routine).w
	move.w	#MusID_Boss,d0
	jsrto	(PlayMusic).l, JmpTo3_PlayMusic
...
+
	...
	jsrto	(SingleObjLoad).l, JmpTo_SingleObjLoad
	bne.s	+
	move.l	#Obj57,(a1) ; load obj57 (MCZ boss)
+
	addq.b	#2,(Dynamic_Resize_Routine).w
	move.w	#MusID_Boss,d0
	jsrto	(PlayMusic).l, JmpTo3_PlayMusic
...
LevEvents_DEZ_Routine1:
	...
	jsrto	(SingleObjLoad).l, JmpTo_SingleObjLoad
	bne.s	+	; rts
	move.l	#ObjAF,(a1) ; load objAF (silver sonic)
